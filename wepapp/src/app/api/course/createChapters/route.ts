...
export async function POST(req: Request, res: Response) {
  try {
    ...
    // If there's a different type of error, you should also return a response here.
    // You might want to change the message and status code based on the type of error.
